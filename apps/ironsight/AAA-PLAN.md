...
Session84 quick check (published per Session85 supervisor, commit2c8d3d1): Training / Undertow, follow Clarifier route or B / Pump Hall. Grey wet concrete, rust beneath ledges and ties, faded olive/ochre machinery and worn flood towers replace the clean mint plant. The dusk sky and puddle reflections remain. Field Conditions2/3 is ON; Switchyard completes the arc next. Two generated carrier attempts were rejected and are not equipped.

Session85 quick check (published per Session86 supervisor, commit d708bbb): Training / Switchyard, follow North bus or South service, then watch FREIGHT / 04 retract. Olive-grey cabinets have fine runoff and chipped edges; damp asphalt catches the overcast sky. The weathered hoist and counterweight carry their finish through the event. Field Conditions3/3 completes the three-map palette/surface arc, ON by default. Issued soldiers/weapons and war damage remain next.

Session86 quick check (local candidate): follow your squad from deployment. Rounded sleeves and trousers, a fitted helmet cover and goggles, faded torso panels and olive underlayers replace the exposed mechanical limbs. ANCHOR and human operators carry a canvas radio pack; its antenna follows their upper body as they crouch and run. Issued Kit1/3 is ON by default. The existing rig and all64 actual animation clips remain; issued weapons are the next stage.

Session87 quick check (local candidate): Training / Relay, fire and reload the AR,
then aim through its compact open optic. Worn steel and olive polymer replace
the clean white/yellow rifle; a taped box magazine and rear charging latch
follow the existing reload phases. Teammates carry the same fitted carbine.
Issued Kit2/3 is ON by default; the other held weapons finish the arc next.
...
Session89 quick check (local candidate): Training / Relay, follow Cooling toward the twin dishes. Three staggered courses of dusty canvas sacks reinforce the exterior comms wall. Approach a service shelter to see chipped concrete, small impacts and powder at its base. The cover remains solid and the existing passages stay open. Fieldworks1/3 is ON. The owner's new map-remaking directive, discovered during final audit, supersedes its remaining cosmetic stages; the structure-layer/enterable Relay building proof is next.

Session90 quick check (local candidate): Training / Relay, find COMMS /01 in the western Cooling shelter. Walk through either open door, use the control consoles and firing windows, follow ROOF ACCESS up the internal ramp, then drop through the south parapet gap. Places A1/1 is ON by default. This is one building proof; whole-map paired positions, bot traffic through interiors and the sunken route are next.
...
ART-CONCEPT.md (owner decision2026-09-10) governs the current direction:
grounded modern warfare, desaturated olive/grey-brown, concrete grey, rust,
layered wear, haze and issued equipment. Relay has hard daylight, Undertow
dusk and wet concrete, Switchyard overcast and damp asphalt. Team torso masses,
enemy rims, readable signs and server-known visibility outrank mood. No copied
brands, unit insignia, identifiable weapon models or other games' layouts.
Earlier session/milestone art descriptions below are historical.
...
| R-L23 | met | Session86 keeps Team/Yellow/Violet on the same prepared program, including uniform colours on the shared radio draw. Live TDM settings check and offline three-map fixtures pass; covered-yellow equals empty cover byte-for-byte. Existing settings/save/reset tests pass; human colour-vision acceptance remains open. |
...
6. **Flow, accessibility and communication (R-L08-10/19-23).** Combined first
   match course, ping acknowledgement and human colour/readability review.
7. **Mode, weapon/audio and movement acceptance (R-L02, R-G01/02/05/08/13/16/18,
   R-M05/12/16).** DOM economy/side swap, weapon FOV, view-kick control,
...
### Session 81 - 2026-09-10: Field Kit arc 1/1 - an armoured squad with readable roles

Read the standing brief, Session81 supervisor status and AAA plan in order,
then all63 design principles and canonical scorecard rows. Entry ironsight-aaa
was clean. Supervisor confirms Session80 commit592b974 and preview deployment
97e06253-61b6-439b-9ccf-b5a903fb4253. Its accepted compositor preparation proof
allows the next ranked visual item. Field Kit1/1 is complete and ON by default.
All changes stay in apps/ironsight/**; no commit, push or deploy.

Reference: **R-G09, R-L12, R-L13, R-L23**, with R-L14's performance constraint.
Checkable targets: three stable role silhouettes, a large team-colour torso/
shoulder mass with quieter flexible sections, the same occlusion/highlight
rules, no extra draw or texture, and prepared geometry before the first fight.
Those checks pass. This is a bounded operator-art pass; first-person hands,
weapon fidelity and human all-range role recognition remain partial.

Delivered original bevelled carriers, shoulders, pouches/straps, back modules
and thigh guards: light asymmetric RUSH, broad paired-shoulder ANCHOR and
raised-collar SCOUT. Existing server botRole IDs choose the appearance once;
weapon swaps, deaths and AOI re-entry cannot change it. Humans use ANCHOR's
balanced carrier. Graphite underlayers, coloured plates and one pale chest
identification bar share the existing atlas and rim shader. Equipment is cosmetic.

The three role buffers are generated once and cached by source geometry. They
merge into the existing skinned draw, use the full quantized inverse-bind
transform and are submitted during loading. Source GLB, source vertices,
animations, head shape and foot/crown normalization are preserved. There is
no added light, texture, render pass, collision cover, stat or wire change.
Source remains ignored; no purchased derivative is exported. No dependency,
Meshy spend or new image/download; reported1530 credits unchanged.

Matched1920x1080 player-height evidence at the same six-metre camera:
[roles before](.inspect/session81-before-roles-after.png) ->
[roles after](.inspect/session81-accepted-roles-after.png);
[yellow before](.inspect/session81-before-contrast-yellow.png) ->
[yellow after](.inspect/session81-accepted-contrast-yellow.png), and the analogous
violet pair. Reduced motion retains the kit. Covered-yellow and empty-cover
PNGs have identical SHA256 hashes: the larger visual gear stays behind cover.
All nine accepted views have zero console errors/forbidden requests.

**Wow check:** 20.813s of natural TDM navigation after real keyboard
highlight changes, 238 replicated-state samples and 425 actual events. Five
stills cover0/5/10/15/20s: session81-live-roles-live-*.png. The existing inspector
uses ordinary movement/look; bots fight naturally. No health/position/role or
room-state injection. Evidence: session81-live-report.json/log and
[review gallery](.inspect/session81-review.html). Intended player sentence:
**"That squad looks equipped for different jobs."** This is an intended response,
not a testimonial or proof of excitement. Screenshots are separate from timing
acceptance. TDM and FFA settings checks preserve allies, update enemy uniforms,
and leave shader counts/material versions unchanged;800x600 control also fits.

Four new regression cases cover stable role mapping, quantized bind transforms,
source isolation/normalization, bone following/cache reuse and opaque shader
colour changes. The actual private GLB separately passes18 role/pose combinations
(idle,walk,sprint,crouch,crouch-walk,death); original deformed vertices remain
within1e-5m of the source and the feet/crown normalization is identical.
Evidence: session81-kit-audit.{ts,mjs,json,log}; rebuild its Node bundle with
esbuild and run it. No derivative is written by that audit. Twenty-seven
pre-compaction close-up rig views cover AR/SMG/sniper, idle/crouch/sprint and
front/back/three-quarter with no errors; representative crouch/sprint/back
stills were reviewed. Final bind audit and accepted map captures were rerun
after replacing the general extrusion helper with the compact plate builder.

Rejected intermediates: session81-candidate-roles-after.png retains floating
equipment from incorrectly inverting mesh.world alone; full skin inversion
fixed it. Candidate captures overlapped a diagnostic rebuild and are not
performance acceptance. session81-fit-* and session81-close-* retain fit/detail
iterations. session81-final-* is the correct but larger general-extrusion
candidate: client2225492bytes. The accepted fixed convex builder removes79917
client bytes, with the same60triangles/part. Final acceptance uses only the
frozen accepted bundle; no build/bake/test/second browser overlaps hitch probes.

On RTX5070 / Edge152 / ANGLE D3D11, balanced/DPR1 at1920x1080:

| Fixture | Calls before -> after | Triangles before -> after | Textures / MiB after | Max ms before -> after |
|---|---:|---:|---:|---:|
|muzzle|237 -> 237|142952 -> 150212|30 / 63.7448|7.2 -> 7.3|
|undertow|209 -> 209|159284 -> 166544|26 / 63.3008|7.2 -> 7.3|
|switchyard|208 -> 208|166956 -> 174216|29 / 63.9948|7.2 -> 13.9|

All retain6.9ms median and7.1ms p95; after p99 is7.1/7.2/7.2ms. Each15s
fixture contains twelve weapon streams/eleven remotes,145volleys and96blasts,
then effects drain. Relay here uses the matched mixed-weapon fixture, unlike
Session80's all-rifle238-call fixture. Program counts33/29/30 are unchanged.
The extra two prepared geometries are the other two cached roles. RUSH/SCOUT
add540triangles each, ANCHOR660; the three complete decoded attribute/index
buffers total1876152bytes (1.7892MiB), shared across actors. This is geometry
storage, separate from the texture estimate; driver/buffer/compositor overhead
and laptop iGPU/thermal acceptance are not covered by these desktop timings.

First fresh-profile local scene construction+preparation is
1.1874 -> 1.2456s.
Per-map stress preparation is615.9->616.3,668.9->1479.0 and737.2->1114.9ms.
All costs precede ready and remain reported; these single-run observations
include first-use rendering work and do not isolate a cause or prove a speedup.
They are local loading, not CDN/network first-load measurements.

| Bytes | Before | After | Delta |
|---|---:|---:|---:|
|assets|27484756|27486035|1279|
|public|34338885|34367569|28684|
|client|2136387|2145575|9188|
|map|4717059|4735276|18217|

Asset growth is README documentation only. Public32.7755MiB is below60MiB;
largest7183364bytes is below25MiB. Added client9188bytes and source map18217bytes;
zero new binary assets. Texture residency remains63.7448/63.3008/63.9948MiB;
no headroom was consumed. Per-map lazy loading,16fixed lights, cached shadows
and one environment preparation are checked by the existing inspector.
Comparisons reproduce with node .inspect/session81-summarize.mjs.

Required verification: pnpm typecheck PASS; pnpm test PASS (641passed,
six existing skips;85passed files/four skipped); pnpm build:client PASS;
pnpm audit:assets PASS. Logs: session81-final-{typecheck,test,build-client,
audit-assets}.log. Exact node scripts/inspect-map.mjs --url http://localhost:8796 --shots relay,practice-two
PASS, zero console errors; report and both stills retained as session81-required-*.
Exact node scripts/hitch-probe.mjs http://localhost:8796 150000 .inspect/hitch.json --assert
PASS and copied to session81-hitch-tdm.json. Supplementary FFA/DOM use --assert
and --assert-first-use. Every probe uses500us CPU profiling and two natural deaths.

| Mode | Seconds / frames | Max frame / callback ms | p99 upper ms | >150ms gaps / share | First damage / death ms | Deaths | Gate |
|---|---:|---:|---:|---:|---:|---:|---|
|TDM|108.479 / 15614|31.2 / 18.4|8|0 / 0.000%|7.9 / 8.2|2|PASS|
|FFA|48.014 / 6915|10.4 / 5.7|8|0 / 0.000%|8.8 / 8.8|2|PASS|
|DOM|96.611 / 13905|26.2 / 8.7|8|0 / 0.000%|8.8 / 8.8|2|PASS|

No shader recompiles or console errors. The unchanged Session74 policy is
1500ms presentation/150ms main-thread/25ms p99/5% stalled time. Every>150ms
ordinary or early interval remains in the raw reports. Session80's five-pair
compositor proof stands; this session does not claim universal stall removal.

| Run | Loading intervals >150ms | After-ready/pre-profiler intervals >150ms |
|---|---:|---:|
|TDM|291.3|590.2|
|FFA|282.4|none|
|DOM|151.4, 270.5|606.9|

These early intervals are not assigned a cause without a covering trace. The
earlier accepted Session80 cold-cache evidence remains applicable to its own
covered intervals only. Frozen client SHA256: 8d8e8909511d11171e9dc4181c441951f775cb551d4d8f5036cd9057e25f48e7.

Fresh tools/reference-audit.ts output deep-equals Session80, with all63 rows
re-reviewed and the gap list re-ranked. Full/waist cover65/46,66/62,64/48;
...
sprint recovery120/100/130/150/90ms; TDM50/300s, respawn3s, DOM4/8s and
0.5point/flag/s; hostile foley1.4, hit900/1400Hz at.28gain, five-row top-right
feed and both damage cues unchanged. Evidence: session81-reference-{audit,comparison}.json.

Open owner questions/defaults: retain these three restrained kit silhouettes(yes);
prioritize first-person weapon/grip fidelity next(yes); add textured fabric next
only after freeing residency(yes). No answer blocks progress. Human visual/
role recognition, colour/readability/comfort, iGPU/thermal, real6v6/RTT and
Firefox/Safari remain unaccepted. No latency/capacity or overall AAA claim.
Cleanup and final scope verification are recorded below after process shutdown.


**Session81 cleanup verified.** Saved root PID20860 and its creation time matched;
all 12 owned preview processes were recorded and descendant identity checked
before shutdown (5 explicit stops; the rest exited with their parents).
session81-preview-tree.json and session81-cleanup.json confirm zero owned
processes, port8796 listeners or inspection browsers remain. Required gates,
...
### Session 84 - 2026-09-10: Field Conditions arc 2/3 - Undertow's weathered reclamation plant

Read the standing brief, Session84 supervisor status and AAA plan in order, then
ART-CONCEPT.md and all63 design-reference principles. Clean entry on ironsight-aaa,
Session83 commit7cc6ab5. Continued the top ranked three-map visual arc: Undertow
now follows Relay's grounded warfare direction, ON by default. Switchyard/85
completes this arc. No commit/push/deploy; scope remains apps/ironsight/**.

Reference: **R-L12, R-L13, R-L14, R-M13, R-M17**, retaining R-G09. Targets: a
visibly desaturated, weathered plant at identical player-height cameras; readable
soldiers, signs and pressure-drop cues; real panel-led runoff; unchanged collision,
draw count, light count and texture residency. Fixed-camera visual checks pass;
whole-overhaul, human readability and representative device acceptance stay partial.
All63 scorecard rows re-reviewed, affected evidence refreshed and gap list re-ranked.
Fresh reference-audit output equals Session83; no gameplay or server edit.

Delivered UNDERTOW_FINISH: grey concrete/steel, faded olive/ochre housings and pale
worn caps, shared between original baked material slots and procedural fallback.
Ground/apron tint is grey-brown; wet regions retain the RG8 mask, smoother normal
response and reflection of the resident dusk sky. Existing small lamp strips are
sodium-coloured surfaces; no new actual light. Sky/key/fog/exposure and their
cached shadows are unchanged. Signs keep readable pale lettering and restrained
lane accents; the original deployment vista was recaptured.

The existing R8 roughness tile supplies broad aging, iron runoff below actual
ledges, rust below recessed form ties, fine paint chips and damp silt at ground
contact. Metric joints/grain and baked AO remain. FloodWorks metal body/gates
share that same resident normal/roughness pair in their existing draws; local
panel coordinates carry the wear with the lifted gates. Opaque water/foam and
phase/status warnings preserve the event. No new image download, transparency,
light, pass, runtime geometry generation, dependency or purchased derivative.

Shared Relay panel-height preparation also supports Undertow, including retained
parent accessors if a later original bake is subdivided. The actual Undertow GLB
has no subdivision metadata; all88924 rendered triangles retain every position,
normal, AO UV and colour. Decoded architecture buffers including the metric UV
channel:8138352 ->12805056bytes (+4666704,4.4505MiB), including2134176bytes of
height attributes. This is separate from texture residency and excludes driver
buffer overhead. Offline attribute preparation44.92ms is a Node measurement,
not a GPU or browser-loading measurement. Evidence/reproduction:
`.inspect/session84-geometry-audit.{ts,mjs,json,log}`; bundle its TS with esbuild.

Rejected intermediates: `session84-candidate-*` had excessive mottling on tall
towers and long, dark runoff. Accepted `session84-final-views-*` reduces broad
contrast and runoff length/strength while keeping ledges and tie stains visible.
One generic Undertow role inspection initially hit a Relay-only asset assertion;
`scripts/inspect-map.mjs` now derives that assertion from the rendered site, so
roles/contrast fixtures can use `?map=arena2` without bypassing asset isolation.
A later actor capture failed with `SyntaxError: Unexpected end of input` in a
partially delivered client bundle during local rebuild activity. Retained in
`session84-roles-timeout-{report.json,log}` plus the failure PNG. A frozen-bundle
rerun passes; no runtime shader/authority workaround was introduced. Role views
are visual evidence only; final timing acceptance is sequential after build and
Blender completion. A stress attempt overlapping live capture/public-doc writes
is retained separately and does not supply final performance numbers.

**Wow check:** matched stills in `.inspect/session84-review.html`, covering home,
Pump Hall, maintenance, raised deck, vista, active sluices, open gallery and its
interior; role and Yellow/Violet pairs also retained. Reduced motion keeps the
same water/cover information. Covered-yellow and empty-cover controls are byte
identical. Intended player sentence: **"This looks like an old wet plant now,
and the soldiers still stand out."** Intended response, not player testimony or
an overall AAA-quality claim. Additional natural DOM footage is reported below.

Meshy: **60credits spent**, account1440 ->1380; **1150credits remain** of the
owner's1300 programme. Latest150/session cap applies; the conservative60/session
note is also met. Two sequential preview/PBR-refine requests,30credits each:

| Candidate | Raw bytes | 512px WebP bytes | Triangles | Disposition |
|---|---:|---:|---:|---|
|field-plate-carrier|6171356|166320|2468|REJECT: warped shoulder edges, folded/faceted pouches|
|field-chest-panel|6651012|230444|3550|REJECT: ignored isolated panel request, another crumpled full vest|

Six front/back/side Blender reviews and metadata live in
`.inspect/session84-meshy`; exact prompts, task IDs and balance receipts are each
candidate's meta.json. Both are one mesh with<=512px textures. Reproduce shrink
with tools/shrink-glb.py --size512 --webp and review with
`.inspect/session84-assets-review.py`. No generated model enters public/gameplay,
so zero added model download/residency and no generated-model gameplay first-load
cost. No rig fitting/adoption claim; keep Session83's staged radio and choose
stronger reference/modelled geometry before another text-only vest attempt.

Open owner questions/defaults: retain this wetter, quieter Undertow direction(yes);
complete Switchyard next(yes); reject both carriers(yes), keep the existing rig and
fit the staged radio before adoption(yes). No answer blocks progress. Human
visual/colour/moving-grip/comfort, laptop iGPU/thermal, real6v6/RTT and Firefox/Safari
remain unaccepted. Performance, final gate evidence and cleanup follow.


**Session84 measurements and static gates.** RTX5070 / Edge152 / ANGLE D3D11,
1920x1080, balanced/DPR1. The accepted stress run is
`session84-accepted-stress-report.json`, sequential after all builds, Blender
jobs and the live browser finished; the earlier overlapping `final-stress`
attempt is excluded from this table. Each fixture runs15s with eleven remote
operators, twelve weapon streams and145volleys/96blasts, then drains effects.

| Stress fixture | Calls before -> after | Triangles unchanged | Texture MiB unchanged | Max frame ms before -> after |
|---|---:|---:|---:|---:|
|Relay mixed weapons|237 ->237|150988|63.7448|7.7 ->7.3|
|Undertow|209 ->209|167320|63.3008|13.9 ->7.4|
|Switchyard|208 ->208|174992|63.9948|7.4 ->14.0|

All medians6.9ms, p95/p99 approximately7.1ms. Texture counts30/26/29 and geometry
counts167/170/160 stay fixed. Programs33/29/30 ->33/30/30: Undertow adds one
normal-mapped instanced gate shader, prepared before play. All16 light objects
and values remain identical in paired views; static shadows stay cached, with
one PMREM generation per scene. This is desktop evidence, not laptop acceptance.
Texture estimates exclude buffers, browser/compositor and driver overhead.

First scene construction+preparation before -> after: Relay1.3898 ->1.4288s,
Undertow0.8944 ->0.9718s, Switchyard0.9516 ->1.7329s. Preparation alone is
1233.7 ->1272.9,785.7 ->865.7,837.5 ->1619.4ms. These single-run local observations
include first-use rendering; they do not isolate the cost of panel preparation
or measure CDN/network latency. The unchanged Switchyard's slower loading is
retained, not attributed to this pass or erased as noise.

| Bytes | Before | After | Delta |
|---|---:|---:|---:|
|assets|27518892|27500815|-18077|
|public|34426190|34415852|-10338|
|client|2154679|2157565|2886|
|source map|4751936|4756789|4853|

Asset delta is the smaller replacement vista plus documentation. Public32.8215MiB
is below60MiB; the unchanged largest file7183364bytes is below25MiB. No generated
model enters gameplay. Switchyard still has only5461 estimated texture bytes
before64MiB; free residency before any equipment textures. Reproduce all
comparisons using `node .inspect/session84-summarize.mjs`; frozen client SHA256:
eef41d810dfcae2e53035f3dee6834d7310ea6e1f627963281ce9519f17b43bc.

The accepted visual set has nine map views and seven role/menu fixtures. Eight
map and six role fixtures have matched baselines; cover/empty images are byte
identical. Exact required inspector command
`node scripts/inspect-map.mjs --url http://localhost:8796 --shots relay,practice-two`
PASS with zero console errors; retained report and stills are session84-required-*.
The20.328s natural DOM capture follows teammates through Pump service with217
replicated-state samples and55 visible-ally samples. See session84-live-report.json,
live-approach-{0,5,10,15,20}s.png and the review gallery. No position/health/bot/clock
injection; visibility samples are not a human recognition verdict.

pnpm typecheck PASS; pnpm test PASS (643passed,6existing skips;86passed files,
4skipped); pnpm build:client PASS; pnpm audit:assets PASS. Logs are
session84-final-{typecheck,test,build-client,audit-assets}.log. Fresh static
reference-audit deep-equals Session83 (session84-reference-comparison.json):
full/waist cover65/46,66/62,64/48; A-B/A-C/B-C sprint rotations14.44/11.78/14.44,
14.22/11.33/14.22,14.44/11.56/14.44s. Spawn travel is not contact timing.
ADS250/200/225/400/165ms; sprint recovery120/100/130/150/90ms; TDM50/300s,
respawn3s; DOM4/8s and0.5point/flag/s; hostile foley1.4; hit900/1400Hz at.28;
five-row top-right feed and both damage cues remain unchanged.


**Session84 hitch acceptance.** Exact required
`node scripts/hitch-probe.mjs http://localhost:8796 150000 .inspect/hitch.json --assert`
PASS, copied to session84-hitch-tdm.json/log. Supplementary FFA and changed-map
DOM each use --mode=<mode> --assert --assert-first-use. Fresh profiles, sequential
browsers,500us CPU sampling and two natural bot deaths each; no build, Blender,
other inspection browser or test run overlaps these acceptance probes.

| Mode | Seconds / frames | Max frame / callback ms | p99 upper ms | >150ms / stalled share | First damage / death ms | Gate |
|---|---:|---:|---:|---:|---:|---|
|TDM|118.781 / 17093|16.3 / 12.6|9|0 / 0.000%|7.8 / 10.8|PASS|
|FFA|59.166 / 8509|14.6 / 9.8|10|0 / 0.000%|12.5 / 8.3|PASS|
|DOM|72.888 / 10244|1087.7 / 19.4|13|2 / 1.758%|25.1 / 22.7|PASS|

Zero shader recompiles and console errors in all three. The **unchanged Session74
policy** remains1500ms presentation,150ms main-thread,25ms p99 and5% stalled time;
first-damage/death stay150ms. This passes that policy, not a universal150ms frame
ceiling. DOM's1087.7ms first measured frame and193.5ms interval at t15908ms remain
in the report;30programs/26textures/170geometries stay resident. The separate
startup observer retains every>150ms interval:

- TDM: before ready 150.3ms, 322.3ms, 175.8ms; after ready none. Ready at 3.5751s; first-ready max 85.0ms.
- FFA: before ready 150.9ms, 151.1ms, 354.2ms; after ready 177.3ms. Ready at 6.3790s; first-ready max 177.3ms.
- DOM: before ready 195.7ms, 335.7ms, 156.9ms; after ready 1760.4ms. Ready at 7.6369s; first-ready max 77.2ms.

DOM's1760.4ms after-ready interval spans the transition into profiling and may
include the same pause as its1087.7ms first measured frame; it is not counted as
an independent additional gameplay stall. No assertion that startup/pre-profiler
frames meet150ms. No threshold or exclusion changed. A separate DOM cross-process
trace investigates the residue below; it cannot retroactively attribute the
acceptance run's193.5ms gap. Compact reproduction:
`node .inspect/session84-hitch-summary.mjs`.

The additional `session84-menu-menu-undertow.png` verifies the actual Domination
selection uses the updated vista; its report also has zero errors. Generic menu
in the role set is a separate Relay menu control. All17 accepted offline
fixtures, the required inspector and natural DOM capture are retained.


**Session84 residual presentation diagnosis.** A separate22s-requested DOM probe
ran24.4765s with --trace-startup --gpu-diagnostics --diagnostic-timing and categories
toplevel,gpu,gpu.angle,cc,viz,blink.user_timing,disabled-by-default-gpu.service.
This is diagnostic only, without --assert/--assert-first-use: no natural damage or
death occurred in that short interval, so its computed gate correctly says FAIL
for fewer than two deaths and its first-use rows say MISSING. It does not replace
the complete passing DOM acceptance run and is retained without relabelling.

The diagnostic reproduces a283.6ms first measured interval (13.8ms max callback,
1.159% stalled share);260/271 CPU samples for that interval are idle. Its resumed
frame submits95draws,11transparent,49materials,142738triangles,30programs,24textures,
170geometries and no shadow refresh. It creates three textures/three texStorage2D,
performs nine texSubImage2D and128buffer-upload bytes, with0.1ms recorded GL
submission time; zero program/shader/buffer/framebuffer creation, compile/link or
texImage2D. These are observed first-use resources, not evidence that the new
surface textures are allocated every frame, and not a measured explanation for
the preceding pause. Heartbeats resume around20ms after an initial53.3ms gap.

The136368698-byte trace contains no long completed shader/executable task in the
selected categories (one0.002ms GetGeometryExecutableTask). Its longest observed
complete task is249.077ms, a browser cache-index write on a background worker;
that correlation does not establish causality. Startup gaps are172.6/349.2/172.5ms
before ready and1217.5ms after ready. The selected trace does not identify the
acceptance run's1087.7/193.5ms pauses or prove a driver/compositor cause. Residual
presentation latency stays explicitly open; no universal stall-removal claim,
no cold-cache-compile label without evidence, and no threshold change.

Raw data: session84-dom-diagnostic.{json,log}, adjacent trace, and
session84-dom-trace-review.{json,log}. Reproduce the compact X/B/E-scope review
with `python .inspect/session84-trace-review.py`; the exact probe command is
`node scripts/hitch-probe.mjs http://localhost:8796 22000 .inspect/session84-dom-diagnostic.json --mode=dom --trace-startup --gpu-diagnostics --diagnostic-timing --trace-categories=toplevel,gpu,gpu.angle,cc,viz,blink.user_timing,disabled-by-default-gpu.service`.
No code/build/public asset changed after acceptance. Cleanup follows.


**Session84 cleanup and final audit.** Preview root63864 matched its recorded
creation epoch1789034409591. Captured twelve owned preview processes, checked
identities before stopping and stopped ten explicitly; the other two exited
with their parents. `session84-preview-tree.json` and `session84-cleanup.json`
confirm zero remaining owned preview processes, port8796 listeners or inspection
browsers. Both Meshy tasks and Blender reviews completed; no owned generator or
Blender process remains. `session84-final-audit.json` verifies the frozen bundle,
unchanged HEAD/branch,63 reference rows, one Session84 log, all passing accepted
browser reports and scope limited to apps/ironsight/**. No commit/push/deploy.
Next session completes Field Conditions3/3 on Switchyard; the broader art and
residual presentation/device work remain open.


### Session 85 - 2026-09-10: Field Conditions arc 3/3 - Switchyard's weathered power depot

Read standing brief, Session85 status and AAA plan in order, then ART-CONCEPT.md
and all63 design references. Clean entry on ironsight-aaa, HEAD2c8d3d1. Completed
the top gap: Field Conditions3/3 is playable and ON by default across all maps.
No commit/push/deploy; all work stays in apps/ironsight/**.

Reference: **R-L12, R-L13, R-L14, R-M08, R-M13, R-M17**, retaining R-G09.
Targets: visibly weathered/desaturated Switchyard at identical cameras; readable
operators, route signs and freight locks; actual ledge-based wear; unchanged
collision, lights, draw count and texture residency. Paired inspections meet
these implementation checks. Human readability, full art overhaul and device
acceptance remain partial. All63 scorecard rows re-reviewed and gaps re-ranked.

Delivered SWITCHYARD_FINISH shared by the original AO bake and procedural
fallback: grey concrete/steel, olive housings, faded ochre and worn pale caps.
Fine iron runoff follows panel tops; corrosion and chipped paint break cabinet
edges while ramp tread remains. Asphalt replaces the yard's regular concrete
grid, with flush sealed repairs, tyre wear, restrained irregular wet patches
and reflection of the existing overcast sky. Original ground R8 intensity/AO and
resident normal/R8 roughness pair supply every scale. No new image, transparent
layer, light, pass, dependency or per-frame resource generation.

Cargo, trolley and playable counterweight use the same resident detail maps in
their existing draws. Packed fixed height/ledge/normal fields stay attached as
they lift, transfer and retract. Gameplay collision/locks, warning/status cues,
sign text and safe occupied recovery retain authority. The deployment vista
was recaptured. No original architecture/AO binary or purchased derivative was
changed. No soldier-body replacement or equipment adoption.

Rejected intermediate: session85-candidate-* had broad vertical bands and overly
dense wet patches. The accepted final-views set narrows/shortens runoff, reduces
large-scale contrast and lowers puddle coverage. The first geometry-audit draft
wrongly expected a single ledge across smooth cylinder triangles; retained as
session85-geometry-audit-initial-failure.log. Its corrected oracle checks planar
faces against triangle extents and smooth faces against per-vertex height. This
was an audit error, not a change to shipped geometry.

**Wow check:** [matched review gallery](.inspect/session85-review.html), eight
map pairs plus six role/highlight pairs, including the moving hoist and both
freight-cover states. A ninth map view retains Reduced motion. Covered-yellow
and empty-cover controls are byte-identical. Intended player sentence:
**"The wet yard and rusty freight look like a place a war could actually reach."**
This is an intended reaction, not player testimony or overall AAA acceptance.
The additional live Cargo Shift drill uses ordinary W/aim inputs and the normal
private-room clock; no position, HP, bot or time injection.

Meshy: **0credits**,0 new candidates/0 asset rejects this session; the material
pass needs no generated silhouette. Account1380 is the latest supervisor receipt,
not a fresh balance query; programme1150 of1300credits remain. Soldier kit and
weapons remain the next priority. No new model download or model first-load cost.

Open owner questions/defaults: retain this overcast worn-depot finish(yes); move
to issued soldiers/weapons next(yes); preserve the existing rig and fit the
staged radio before adoption(yes). No answer blocks progress. Human visual,
colour-vision/moving-grip/comfort, laptop iGPU/thermal, actual6v6/RTT and
Firefox/Safari remain unaccepted.

**Measurements and verification.** RTX5070 / Edge152 / ANGLE D3D11,
1920x1080, balanced/DPR1. Sequential final stress checks run after the build and
static gates, without other inspection browsers or asset-generation jobs. Each
fixture has11 remote operators,12 weapon streams and15s of effects, then drains.

| Stress fixture | Calls before -> after | Triangles | Texture MiB | Max frame ms before -> after |
|---|---:|---:|---:|---:|
|muzzle-effects-stress|237 ->237|150988|63.7448|14.1 ->21.1|
|undertow-effects-stress|209 ->209|167320|63.3008|34.7 ->13.9|
|switchyard-effects-stress|208 ->208|174992|63.9948|14.0 ->14.0|

All medians6.9ms; p95/p99 and first-load samples are retained in
`session85-summary.json`. All16 light objects/values stay identical, static
shadows stay cached and PMREM is generated once per scene. Switchyard adds one
prepared vertex-colour/detail cargo program (30 ->31); Relay/Undertow stay33/30.
Texture counts30/26/29 and geometry counts167/170/160 are unchanged. This desktop
run is not laptop performance acceptance.

First construction+preparation for muzzle-effects-stress: 3.5855 ->1.4851s (preparation 3343.5 ->1308.6ms).
First construction+preparation for undertow-effects-stress: 3.3752 ->1.1187s (preparation 3264.2 ->1010.8ms).
First construction+preparation for switchyard-effects-stress: 2.6825 ->1.0064s (preparation 2579.1 ->901.6ms).
These are single-run local first-use observations, not CDN/network measurements
or isolated estimates of shader cost. No extra texture download/residency.

Actual original architecture audit preserves every rendered position, normal,
AO UV, colour and existing metric/panel coordinate across93704triangles.
Decoded buffers 11454880 ->20193408bytes (+8738528,
8.3337MiB), including4497792bytes of new weather attributes.
This excludes dynamic cargo buffers and driver overhead. Node preparation
62.24ms is not a browser/GPU timing. Five actual hoist poses retain
identical attribute buffers. Reproduce by bundling/running
`.inspect/session85-geometry-audit.ts` with esbuild.

| Bytes | Before | After | Delta |
|---|---:|---:|---:|
|assets|27500815|27496833|-3982|
|public|34415852|34428506|+12654|
|client|2157565|2163654|+6089|
|map|4756789|4767336|+10547|

Public32.8336MiB stays below60MiB; largest file7183364bytes
is below25MiB. Asset changes are the smaller replacement vista and provenance
documentation. Estimated texture memory still leaves only5461bytes before64MiB
on Switchyard; free residency before adding kit. Frozen client SHA256:
`c8e8beddd1d679f198aaf9410db7c34e36b8a6073f0f67cc1f4d1047d4897042`.

Live Cargo Shift sequence lasts21.177s with115samples;
all blocked/crossing/lift/travel/occupied-hold/restoration/radar/epoch/audio/layout
checks pass. Stills and raw data: session85-live-*, including the20s sequence
in the gallery. Nine map fixtures, six role fixtures, actual Switchyard menu,
required inspector and live drill have zero console errors.

pnpm typecheck PASS; pnpm test PASS (643passed,6existing skips;86passed files,
4skipped); pnpm build:client PASS; pnpm audit:assets PASS. Exact required
`node scripts/inspect-map.mjs --url http://localhost:8796 --shots relay,practice-two`
PASS; copied to session85-required-*. Logs: session85-final-{typecheck,test,
build-client,audit-assets}.log. Fresh reference audit deep-equals Session84:
cover65/46,66/62,64/48 full/waist; sprint rotations14.44/11.78/14.44,
14.22/11.33/14.22,14.44/11.56/14.44s; ADS250/200/225/400/165ms and sprint
recovery120/100/130/150/90ms. TDM50/300s, respawn3s, DOM4/8s and0.5point/flag/s,
hostile foley1.4, hit900/1400Hz at.28, five-row feed and two damage cues retained.
Spawn travel is not contact timing. Reproduce summary via
`node .inspect/session85-summarize.mjs`.

**Hitch acceptance.** Exact required TDM command:
`node scripts/hitch-probe.mjs http://localhost:8796 150000 .inspect/hitch.json --assert`.
FFA uses `--mode=ffa --assert --assert-first-use`. Fresh profiles, sequential
browsers and two natural bot deaths each, without build/test/Blender overlap.
The unchanged Session74 policy is1500ms presentation,150ms main-thread,25ms p99,
5% stalled time; first-damage/death remain150ms. No threshold or exclusion change.

| Mode | Seconds / frames | Max frame / callback ms | p99 upper ms | >150ms / stalled share | First damage / death ms | Gate |
|---|---:|---:|---:|---:|---:|---|
|TDM|85.478 / 12298|17.6 / 13.2|8|0 / 0.000%|8.5 / 8.5|PASS|
|FFA|49.928 / 7060|913.0 / 6.4|9|1 / 1.829%|8.0 / 8.8|PASS|

Zero shader recompiles/console errors in both. Every >150ms startup or measured
interval stays in session85-hitch-{tdm,ffa}.json, summarized below. Passing this
policy does not establish a universal150ms frame ceiling or representative
device acceptance. Session80 five-pair compositor first-use proof stands.

- TDM: startup before ready282.1ms ending at page2021.4ms; after ready none;
  ready at3.2183s, first-ready maximum70ms. No measured >150ms spike.
- FFA: startup before ready270.5ms ending at page2027.4ms; after ready1496.9ms
  ending at page6484.3ms; ready at3.2930s, first-ready maximum63.4ms. The first
  profiled frame lasts913ms, with31programs/29textures/160geometries resident.
  Its CPU profile has876 idle samples out of888. This interval overlaps the
  after-ready startup gap; it is not an independent second gameplay pause.

Raw preparation gaps can overlap profiler-start measurements; they are not
automatically independent gameplay stalls. No unsupported driver/compile
causality claim. Cleanup and final scope audit follow.

**Session85 residual presentation diagnostic.** The separate22.3397s FFA run
uses --trace-startup, --gpu-diagnostics and --diagnostic-timing, without --assert.
It has no natural death, so its computed gate correctly says FAIL for fewer
than two deaths; first damage11.1ms PASS, death MISSING. It is diagnostic evidence,
not an acceptance run, and does not replace the complete passing TDM/FFA probes.

It reproduces a465.8ms first measured interval (6.4ms callback), with437/452 CPU
samples idle. Heartbeat timers continue near20ms after an initial53.1ms gap;
profiler setup takes112.4ms. The resumed render submits111draws (47transparent,
80materials; renderer.info110calls),136407triangles,31programs/29textures/
160geometries. No shadow refresh, texture/framebuffer/buffer/program/shader
creation, texImage2D/texStorage2D, mip generation or shader compile/link occurs.
It uploads256buffer bytes and updates six existing textures. These observations
do not establish a cause for the preceding delayed presentation.

The137653046-byte cross-process trace has a2.659ms GetVertexExecutableTask and
nested2.538ms D3DCompile containing Skia attributes, plus two0.001ms geometry
executable tasks. No observed long compile explains the pause; the longest
complete task in the selected categories is123.755ms on a browser background
search-engine metadata worker. That correlation is not evidence of causality.
Diagnostic startup gaps:293.1ms before ready;515.2/617.3ms after ready, with the
last overlapping the first-profiler interval. First-ready maximum68.3ms, ready
at2.5535s. No console errors/recompiles. Residual presentation/device acceptance
remains open; no claim that this occurrence is a cold-GPU-cache compile.

Raw evidence: session85-ffa-diagnostic.{json,log}, adjacent trace and
session85-ffa-trace-review.{json,log}. Reproduce compact X/B/E task analysis with
`python .inspect/session85-trace-review.py`. Exact diagnostic command:
`node scripts/hitch-probe.mjs http://localhost:8796 22000 .inspect/session85-ffa-diagnostic.json --mode=ffa --trace-startup --gpu-diagnostics --diagnostic-timing --trace-categories=toplevel,gpu,gpu.angle,cc,viz,blink.user_timing,disabled-by-default-gpu.service`.

**Session85 cleanup.** Preview root47648 matched recorded creation epoch
1789036209148. Twelve owned processes captured; eleven identity-checked stops,
one child exited with its parent. session85-preview-tree.json and
session85-cleanup.json confirm no remaining owned processes, port8796 listener
or inspection browser. No generator/Blender task was started. No source, public
asset or bundle changed after acceptance. Final audit verifies the frozen
client, unchanged HEAD/branch,63 reference rows, one Session85 log, passing
accepted reports and apps/ironsight/** scope. No commit/push/deploy.

### Session 86 - 2026-09-10: Issued Kit arc 1/3 - field uniforms and radio operators

Read standing brief, Session86 supervisor status and AAA plan in order, then
ART-CONCEPT.md and all63 references. Clean entry on ironsight-aaa, HEADd708bbb.
Completed the top visual stage; Issued Kit1/3 is playable and ON by default.
No commit/push/deploy; changes stay in apps/ironsight/**.

Reference: **R-G09, R-L12, R-L13, R-L14, R-L23**, retaining R-G12/G20.
Targets: clothed limbs and issued equipment visibly change the squad at matched
cameras; large torso team masses, opaque cover occlusion and colour options
remain; no additional actor draw/light/pass; all original clips, vertices and
normalization remain valid. Implementation checks pass; human recognition,
moving-grip/comfort and Battlefield-level fidelity remain partial. Every
scorecard row was re-reviewed; gaps are re-ranked above.

Delivered rounded tapered sleeves/trousers, fitted helmet cover and goggles,
matte olive underlayers, faded torso/shoulder team panels and a helmet band.
Original bind-position attributes drive fine weave, mottled dye and abrasion
without swimming during animation or adding an image. Neutral equipment has a
quieter rim; the torso keeps its larger team-colour mass and stronger edge.
The complete character stays opaque and depth-tested under every highlight.

Adopted Session83's generated radio for anchors and human operators:0.26x0.46x
0.18m, controls rearward, short antenna below the original crown. Albedo is baked
into original prop vertices; full inverse-bind fitting rigidly weights those
vertices to spine_03 and merges them into the existing skinned draw. Appended
radio triangles are removed from client hit-claim intersections. Equipment
does not alter stats, collision, server hit validation or weapon transforms.
No source soldier GLB or purchased derivative was changed/exported.

The shared2048x2048 soldier atlas is downsampled to512x512 once during model
loading, preserving UVs and source material parameters. This frees20MiB of
mipmapped texture residency. The original download remains the same size;
this is a residency saving, not a20MiB network saving. Radio loading runs only
alongside actors; maps retain their existing lazy assets. Role geometry and
the radio are prepared/cached before play; no per-frame bake/resource churn,
new dependency, light or render pass.

**Wow check:** [matched review gallery](.inspect/session86-review.html): nine
front/back/three-quarter rig pairs across idle/crouch/sprint, plus role and
Yellow/Violet pairs on all three maps. Relay baselines were captured this
session; unchanged Undertow/Switchyard environment baselines are retained from
Sessions84/85 and checked against the same lighting/fixture. Intended player
sentence: **"The squad finally looks dressed for field work, and I can spot the
radio operator."** This is a target reaction, not player testimony. The extra
natural TDM sequence and real keyboard highlight changes are retained in
session86-live-*. No HP/position/bot/clock injection; exact duration below.

Rejected intermediates: paint alone still exposed mechanical limbs; added
fitted cloth geometry. A spherical helmet intersected the squared source crown;
the fitted rounded-square cover preserves the original height. The first
radio orientation buried its controls; the adopted orientation faces rearward.
A separate PBR radio draw failed the unchanged240draw/32texture budget at248/
33; vertex albedo plus the shared draw restores237/30 in the worst Relay
fixture. First vertex export selected an old white colour layer; the bake now
removes old layers, links the baked colour and rejects an empty/white result.
These candidates remain inspectable and are not acceptance evidence. Initial
typecheck also exposed a DOM-type leak through the shared rig loader; the
browser adapter now keeps DOM globals out of the server test context.

The actual private asset contains**64 clips**, not the brief's55. The first
audit's55-count assertion failed and remains in session86-pose-audit-initial-
count.log; no clip was added/removed. The corrected actual-asset audit covers
3roles x64clips x2sample times =384pairs, unchanged original vertices within
8.686e-8m, finite fitted equipment, matching feet/crown bounds and rigid radio
spine weights. Two added regression cases check preparation/source isolation
and real raycast filtering/bone following. Reproduce with esbuild on
.inspect/session86-pose-audit.ts, then Node; no derivative is written.

Meshy: **60credits this session**, fresh account1380 ->1350 ->1320;
programme1090 of1300credits remain. Two carbine candidates shrunk and inspected:
field-carbine raw7189120 ->277164bytes/3331triangles, rejected for distorted
receiver/optic; field-carbine-clean raw6910652 ->255784bytes/2933triangles,
staged for next session's grip/muzzle review, not adopted. Both have3x512px
PBR images and remain outside public. The shipped radio cost30credits in
Session83, not again here: raw7767328 ->188000-byte PBR intermediate ->
260176-byte vertex GLB/1895triangles/zero textures. Provenance, task IDs, hash
and reproducible Blender commands are in public/assets/README.md.

**Measurements.** RTX5070 / Edge152 / ANGLE D3D11,1920x1080,balanced/DPR1.
Each final stress fixture runs15s of eleven operators, twelve weapon streams,
145volleys/96blasts and then drains. No builds/tests/Blender/second browser
overlap final stress or hitch acceptance. This desktop is not laptop acceptance.

| Stress fixture | Calls before -> after | Triangles before -> after | Texture MiB before -> after | Max frame ms before -> after |
|---|---:|---:|---:|---:|
|Relay mixed weapons|237 ->237|150988 ->181249|63.7448 ->43.7448|7.2 ->13.9|
|Undertow|209 ->209|167320 ->197581|63.3008 ->43.3008|13.9 ->7.2|
|Switchyard|208 ->208|174992 ->205253|63.9948 ->43.9948|20.8 ->7.3|

All medians6.9ms, p95 7.1ms, final p99 7.1/7.1/7.2ms. Programs33/30/31,
textures30/26/29 and geometries167/170/160 are unchanged. All16 light objects
retain type/colour/intensity; shadows stay cached and PMREM runs once per scene.
The three role buffers grow from1876152 to3621990bytes (+1745838,1.665MiB)
in the matched lineup; radio source/preparation buffers and driver overhead
are additional. Final uniforms add1396triangles for RUSH/SCOUT and3411 for
ANCHOR including1895radio triangles. All draws/resource limits pass unchanged.

Single-run local construction+preparation: Relay1.4434 ->1.3887s;
Undertow0.9238 ->0.9907s; Switchyard0.9750 ->1.1649s. Preparation alone:
1279.4 ->1237.5ms,817.2 ->886.1ms,866.3 ->1052.2ms. These observations include
loading and first-use rendering, not CDN latency or isolated shader cost;
the slower Undertow/Switchyard samples remain reported.

| Bytes | Before | After | Delta |
|---|---:|---:|---:|
|assets|27496833|27759231|+262398|
|public|34428506|34715679|+287173|
|client|2163654|2172261|+8607|
|source map|4767336|4783504|+16168|

Public33.1075MiB stays below60MiB; largest7183364bytes stays below25MiB.
Frozen client SHA256:b0d00e8051581bedb8848cf986ddcdab2747c620829ee189020bcbca92b2deba.
Reproduce comparisons with node .inspect/session86-summarize.mjs. Matched
covered-yellow and empty-cover PNGs are byte-identical. All final rig,
three-map roles/highlights and stress reports have zero console errors or
forbidden requests. Every source geometry and purchased binary stays private.

pnpm typecheck PASS; pnpm test PASS (645passed,6existing skips;87passed files,
4skipped); pnpm build:client PASS; pnpm audit:assets PASS; pnpm build Worker
dry run PASS. Logs: session86-final-{typecheck,test,build-client,audit-assets,
build-worker}.log. Fresh reference audit deep-equals Session85: cover65/46,
66/62,64/48 full/waist; A-B/A-C/B-C sprint rotations14.44/11.78/14.44,
14.22/11.33/14.22,14.44/11.56/14.44s. ADS250/200/225/400/165ms, sprint
recovery120/100/130/150/90ms; TDM50/300s, respawn3s, DOM4/8s and0.5point/
flag/s, hostile foley1.4, hit900/1400Hz at.28, five-row feed and two damage cues.
Spawn travel is not measured contact timing.

Open owner questions/defaults: keep the fitted uniform and radio(yes); inspect
and fit the simpler staged carbine next(yes); preserve existing rig and
server authority(yes). No answer blocks progress. Human visual/colour-vision/
moving-grip/comfort, laptop iGPU/thermal, actual6v6/RTT and Firefox/Safari remain
unaccepted. Hitch acceptance, natural sequence timing and cleanup follow below.


**Session86 hitch acceptance.** Exact required inspector and TDM probe:
`node scripts/inspect-map.mjs --url http://localhost:8796 --shots relay,practice-two`
and `node scripts/hitch-probe.mjs http://localhost:8796 150000 .inspect/hitch.json --assert`
both PASS. Required captures/report copied to session86-required-*.
FFA/DOM use --mode=<mode> --assert --assert-first-use. Sequential fresh browser
profiles, two natural bot deaths each, no build/test/Blender/second-browser
overlap. The unchanged Session74 policy is1500ms presentation,150ms main-thread,
25ms p99 and5% stalled time; first damage/death remain150ms. No exclusion or
threshold changed. Session80's five-pair compositor proof stands.

| Mode | Seconds / frames | Max frame / callback ms | p99 upper ms | >150ms / stalled share | First damage / death ms | Gate |
|---|---:|---:|---:|---:|---:|---|
|TDM|104.383 / 15025|19.5 / 14.6|8|0 / 0.000%|10.5 / 8.5|PASS|
|FFA|42.769 / 6051|750.3 / 10.4|8|1 / 1.754%|8.0 / 8.8|PASS|
|DOM|82.241 / 11759|575.4 / 14.9|8|1 / 0.700%|8.2 / 8.2|PASS|

Zero shader recompiles or console errors in all three probes. Every measured
and startup >150ms interval remains in the reports; passing the established
policy does not establish a universal150ms frame ceiling or laptop acceptance.

- TDM: before-ready gaps 276.0ms ending at page2029.5ms; 153.9ms ending at page2851.8ms; after-ready gaps none. Ready at 3.2811s; first-ready maximum 92.5ms. Measured gaps: none.
- FFA: before-ready gaps 256.4ms ending at page2113.5ms; after-ready gaps 1392.0ms ending at page6529.3ms. Ready at 3.4845s; first-ready maximum 95.1ms. Measured gaps: 750.3ms at profile t750ms (31programs/29textures/160geometries).
- DOM: before-ready gaps 284.3ms ending at page2099.7ms; 156.3ms ending at page2791.1ms; after-ready gaps 1166.9ms ending at page6155.9ms. Ready at 3.2319s; first-ready maximum 93.7ms. Measured gaps: 575.4ms at profile t576ms (30programs/26textures/170geometries).

The FFA first-profiler750.3ms interval overlaps its after-ready1392.0ms gap;
they are not automatically independent gameplay stalls. No causal driver/
compositor/compile assertion follows from timing alone. Residual presentation
and device acceptance remain open; no new threshold or silent spike removal.
Compact reproduction: node .inspect/session86-hitch-log.mjs (writes the summary;
its duplicate-log guard prevents a second session appendix).

Natural TDM capture lasts20.823s with199replicated-state samples and277incoming
events; ordinary navigation plus Team/Yellow/Violet keyboard checks. The
required inspector, live capture, nine rig views, twelve map/highlight views
and three stress fixtures all have zero console errors. session86-live-report.json
and the0/5/10/15/20s stills are retained in the review gallery.

**Session86 cleanup and final audit.** Preview root67016 matched its recorded
creation epoch1789038168870. Twelve owned processes captured, eleven stopped
after identity checks; one exited with its parent. session86-cleanup.json
confirms zero owned preview processes, port8796 listeners or inspection browsers.
Both Meshy tasks and Blender jobs completed. The initial preview was restarted
to refresh its asset manifest after the new radio first returned404; final
browser reports contain no such errors. No source/public/bundle change follows
acceptance. session86-final-audit.json verifies the frozen bundle/radio hashes,
all accepted reports, one Session86 log,63 reference rows, unchanged branch/HEAD
and apps/ironsight/** scope. No commit/push/deploy. Issued Kit2/3 is next.


### Session 87 - 2026-09-10: Issued Kit arc 2/3 - an issued carbine in both held views

Read standing brief, supervisor Session87 status and AAA plan in order, then
ART-CONCEPT.md and all63 reference principles. Clean entry on ironsight-aaa,
HEAD3f167f9. Completed the top gap: Issued Kit2/3 is playable and ON by default.
Scope apps/ironsight/** only; no commit/push/deploy. Updated the stale top-level
art paragraph to the already approved grounded-warfare concept and re-ranked
the gap list for stage3. No owner answer was needed.

Reference: **R-G09, R-G12, R-G18, R-L12, R-L13, R-L14**, retaining R-G20.
Targets: an issued-looking AR at the same first-person/remote cameras; a clear
optic-centre ray and magazine/latch actions on the existing server deadline;
same64 soldier clips, authoritative aim/hits and weapon timings; no added
light, render pass or remote weapon draw. Implemented checks pass. Separate
weapon FOV(R-G18), human moving-grip/comfort and Battlefield-level art acceptance
remain partial. This stage does not claim the entire overhaul is finished.

Adopted Session86's second generated carbine receiver, stock and slotted
handguard. Fitted the grip/receiver proportions to the existing hand frames,
preserving the1.20m asset-space length and0.72m remote length. Removed the
uneven front post, merged an original low open reflex housing into the receiver,
and retained the existing tiny ADS dot without glass or a new optical pass.
The bore tip comes from the foremost vertex slice; actual shipped tip is
(0.004971,-0.018718,0.749183), sight centre y0.085. A real ray through that
centre hits no weapon geometry. First person retains0.65 scale and its existing
rest/camera transform; support-hand magazine and rear-latch contacts are fitted.

The generated folded magazine underside was rejected in the reload view.
An original capped box magazine with a tape band and separate charging latch
replace it. Both share the receiver's PBR images and move through the existing
reload groups. Remote templates share immutable source buffers and cache the
offline parts once. New configured per-slot overrides use one selection helper
for first person, remote holds and loading-screen preparation. Preparation
warms every configured weapon before play; other four slots retain their private
bundle. No source soldier/purchased weapon file was changed or re-exported.
Weapons remain excluded from hit-claim raycasts; the server rules are unchanged.

The texture estimate now includes cached preparation materials, even when no
visible operator holds an older weapon. An intermediate all-AR report wrongly
appeared to save the hidden21.333MiB weapon atlas; that report is retained but
is superseded by session87-verified-stress. No such saving is claimed. This
fix makes the unchanged64MiB limit cover that known resident cache too.

**Wow check:** [matched review gallery](.inspect/session87-review.html), six
AR hip/ADS/reload/cycle pairs and nine remote idle/crouch/sprint pairs. The rig
inspector uses its existing diagnostic actor material; production actor art is
unchanged. Four aimed and two remote-reload fixtures accompany the pairs.
Player sentence: **“That looks like an issued rifle now, right down to the taped
reload.”** This is an intended reaction, not player testimony. The natural
TDM sequence lasts20.735s, with200 replicated-state samples and322 incoming
events, captured at0/5/10/15/20s through ordinary navigation. No state, HP,
clock or bot injection. A separate20.045s Training sequence switches/fires all
five weapons:18 server-confirmed shots,8hits, all flash tails expire. That
existing drill uses keyboard/mouse plus its camera-aim helper.

Rejected intermediates: first fit had the grip ahead of the firing wrist and
the old tall optic dominated the thin receiver; both were corrected. The
generated front post and folded magazine/chip were rejected; the final magazine
is original. Three-texture PBR was declined in favour of two512px images
(albedo + packed metallic/roughness) to retain the32-texture cap; no normal map
is shipped. Early typecheck caught a tuple spread and Node-only test I/O typing;
the full suite then exposed a fixture hard-coded to the old AR node. The
fixture now follows configured selection while retaining length, hand following,
ray exclusion, stale-load and ownership checks. Three additional real-asset/
selection cases pass. No gate threshold or test assertion was weakened.

Meshy: **0 credits this session**, fresh balance1320; programme1090 of1300
remain. This asset's30 credits were charged in Session86. Raw6,910,652 bytes
->512px shrunk255,784 -> fitted320,296 bytes,3210triangles, three meshes,
one material, two shared512px images. Actual decoded geometry262,348bytes;
cached source/driver overhead are additional. Provenance, task IDs, hash and
reproducible shrink/fit commands are in public/assets/README.md. Purchased
derivatives remain ignored; the generated weapon is explicitly allowlisted.

**Measurements.** RTX5070 / Edge152 / ANGLE D3D11,1920x1080,balanced/DPR1.
Each final stress fixture runs15s with eleven operators and twelve weapon
streams plus blasts, then drains. No builds/tests/Blender/second browser overlap
stress or hitch acceptance. This is not laptop iGPU acceptance. Session87
captured matched all-AR baselines; the actual mixed-weapon baseline is the
unchanged Session86 verified fixture. The internal “mixed-effects-stress” shot
is all ARs; only “muzzle-effects-stress” uses mixed weapon classes.

| Fixture | Calls before -> after | Triangles before -> after | Texture MiB before -> after | Max frame ms before -> after |
|---|---:|---:|---:|---:|
|Relay all AR|239 ->238|188399 ->196403|43.7448 ->46.4115|7.2 ->13.9|
|Relay mixed weapons|237 ->236|181249 ->183877|43.7448 ->46.4115|13.9 ->7.3|
|Undertow|209 ->208|197581 ->205585|43.3008 ->45.9674|7.2 ->7.8|
|Switchyard|208 ->207|205253 ->213257|43.9948 ->46.6615|7.2 ->14.0|

All medians6.9ms and p95/p99 approximately7.1ms. Final programs34/34/31/32,
textures32/32/28/31, geometries158/158/161/151. One fewer local draw because
the optic housing shares the receiver; no added remote draw. All16 light
objects retain type/colour/intensity, shadows remain cached and PMREM runs once
per scene. Texture increase is2.6667MiB for two shared mipmapped512px images.
Worst238calls and213257triangles pass the unchanged240/500k stress limits.

Local construction+preparation observations: Relay all-AR1.0542 ->1.7410s;
Relay mixed1.3887 ->0.6563s; Undertow0.9651 ->0.9625s; Switchyard1.0824
->1.0402s. Preparation alone after:1588/572/861.5/933.8ms. The Relay all-AR
baseline follows earlier weapon stills, while the final all-AR fixture starts
a fresh inspector profile. These single-run observations include differing
browser/driver cache histories, not isolated shader cost or CDN/network timing.
Cold gameplay readiness is reported with the hitch data below.

| Bytes | Before | After | Delta |
|---|---:|---:|---:|
|assets|27759231|28082045|+322814|
|public|34715679|35043775|+328096|
|client|2172261|2173886|+1625|
|map|4783504|4787161|+3657|

Public33.4203MiB stays below60MiB; largest
7,183,364bytes stays below25MiB. Map lazy loading remains; shared weapon loads
run with the viewmodel. Frozen client SHA256:
`18ce0f802a09010cd0e149978623cdf30acd105a814ec5327875bb921b7a54b7`.
Carbine SHA256:`c6bc34fa6240ad9db54324d7bad3a85846526951fb1ff75eb3719492c428b5a6`.
Reproduce summary via node .inspect/session87-summarize.mjs.

pnpm typecheck PASS; pnpm test PASS(648passed,6existing skips;88passed files,
4skipped); pnpm build:client PASS; pnpm audit:assets PASS; pnpm build Worker
dry run PASS. Logs: session87-final-{typecheck,test,build-client,audit-assets,
build-worker}.log. Required inspector exact command PASS with zero errors:
`node scripts/inspect-map.mjs --url http://localhost:8796 --shots relay,practice-two`.
Copied required stills/report to session87-required-*. All20 weapon/live-shot
views, nine neutral rig views, four aimed views, two reload views, four stress
fixtures and the natural TDM report have zero console errors/forbidden requests.

Fresh tools/reference-audit.ts output deep-equals Session86. Full/waist cover
65/46,66/62,64/48; A-B/A-C/B-C sprint rotations14.44/11.78/14.44,
14.22/11.33/14.22,14.44/11.56/14.44s. ADS250/200/225/400/165ms;
sprint recovery120/100/130/150/90ms. TDM50/300s, respawn3s, DOM4/8s,
0.5point/flag/s. Hostile foley1.4, hit900/1400Hz at.28, five-row feed and
two damage cues retained. Spawn travel is not measured contact timing.

**Hitch acceptance.** Exact required TDM command:
`node scripts/hitch-probe.mjs http://localhost:8796 150000 .inspect/hitch.json --assert`.
FFA uses --mode=ffa --assert --assert-first-use, sequential fresh profiles and
two natural deaths each. Session74's accepted policy remains1500ms presentation,
150ms main-thread,25ms p99 and5% stalled time; first damage/death remain150ms.
No threshold or exclusion changed; Session80's five-pair first-use proof stands.

| Mode | Seconds / frames | Max frame / callback ms | p99 upper ms | >150ms / stalled share | First damage / death ms | Gate |
|---|---:|---:|---:|---:|---:|---|
|TDM|66.245 / 9526|67.4 / 10.7|8|0 / 0.000%|7.7 / 9.1|PASS|
|FFA|59.197 / 8352|1191.5 / 13.5|8|1 / 2.013%|12.7 / 10.3|PASS|

Zero shader recompiles and console errors in both. All >150ms startup and
measured intervals remain in the raw reports and are listed here:

- TDM: before-ready gaps 279.3ms ending at page2123.5ms; 165.2ms ending at page3058.1ms; after-ready gaps 532.2ms ending at page5737.4ms. Ready at 3.4968s; first-ready maximum 92.6ms. Measured gaps: none.
- FFA: before-ready gaps 263.2ms ending at page2216.6ms; after-ready gaps 1764.7ms ending at page7033.0ms. Ready at 3.5600s; first-ready maximum 72.2ms. Measured gaps: 1191.5ms at profile t1191ms (32programs/31textures/151geometries).

The FFA1191.5ms first-profiler interval overlaps startup presentation; these
measurements are not automatically independent gameplay pauses. Timing alone
does not establish a driver/compositor/compile cause. Passing the accepted
policy does not establish a universal150ms frame ceiling or laptop acceptance.
Residual presentation, human visual/colour-vision/moving-grip/comfort, actual
6v6/RTT and Firefox/Safari remain unaccepted. Reproduce the compact report with
node .inspect/session87-hitch-summary.mjs; no spikes were removed.

Open owner questions/defaults: keep the fitted carbine and compact optic(yes);
complete coherent held-weapon/first-person finishes next(yes); keep the original
rig and authority(yes); pack/reuse textures before further Meshy weapons(yes).
No answer blocks progress. Cleanup and final scope audit follow.

**Session87 cleanup and final audit.** Preview root 71276 matched
its recorded creation time 2026-09-10T11:43:24.8630806Z. Captured 12 owned
processes; 10 identity-checked stops, the others exited with their
parents. session87-cleanup.json confirms no remaining owned processes,
port8796 listener or inspection browser. All Blender tasks finished; no
Meshy generation task was started. No source/public/bundle changed after
acceptance. session87-final-audit.json verifies frozen hashes, all accepted
...
### Session 89 - 2026-09-10: Fieldworks arc 1/3 - Relay comms defenses and blast traces

Read standing brief, Session89 supervisor status and AAA plan in order, then
ART-CONCEPT.md and all63 reference principles. Clean entry on ironsight-aaa,
HEAD c9278ba. Top visual gap selected; Fieldworks1/3 is playable and ON for
Relay. Planned Switchyard/Undertow stages are superseded by the late owner
map-remaking directive documented at session close. Scope is
apps/ironsight/** only; no commit/push/deploy.

Reference: **R-M03, R-M11, R-M13, R-M17, R-L12, R-L13, R-L14**, retaining
R-G09. Targets: a fortified communications silhouette; damage on intact
authoritative cover, no false openings; <=2cm surface cladding, exterior sacks
entirely outside play; zero extra draws/textures/lights/passes; unchanged
240draw/500k/32texture/64MiB gates. Implemented checks pass. This stage adds
static battle traces, not structural destruction or new tactical cover.
Human art/readability and representative hardware approval remain open.

`client/relay-fieldworks.ts` assembles one generated filled sack into96 sacks,
eight three-course sections in two lines on Relay's existing northern coping.
The source is fitted to0.67x0.235x0.44m; final geometry remains atz<=-0.07m,
y2.89..3.535m. The existing boundary encloses every player. Four service
shelters receive eight broad shallow spall patches, eight chip clusters and
eight flat powder aprons. Wall patches sit17mm outside solid faces; ground
patches are19mm above open ground. Cover classes, colliders, ramps, bot paths,
map event geometry, authoritative shots and all64 soldier clips remain intact.

Everything joins the existing service geometry and one1024x1024 atlas. Its
upper-left service art is preserved; the generated512px albedo is dyed khaki
and packed at upper right, original damage below. Source GLB textures never
upload independently and are disposed after copying. The map awaits loading
before normal preparation, including the alpha-tested material. No per-frame
paint, transparency sorting, light, pass or additional draw. Relay-only request
checks pass; Undertow/Switchyard never fetch this asset. The existing dark
coping/foundation material also receives a fixed polygon offset, shared by
fallback and baked kit, resolving its pre-existing coplanar flicker without
rebaking or changing geometry.

**Wow check:** [matched review gallery](.inspect/session89-review.html): six
before/after pairs, including identical wall/shelter cameras, an elevated sack
detail view and rejected art. Player sentence: **“They've fortified the dishes,
and these buildings have already taken hits.”** Intended reaction, not player
testimony. The normal TDM sequence lasts20.784s with199 replicated-state
samples and236 incoming events; five stills at0/5/10/15/20s. Ordinary W/aim
navigation toward the central approach, no HP/position/clock/bot injection.
The fixed pairs show the new detail more clearly than that natural round.

Rejected intermediates: two generated walls (tiny angular courses, then folded
slab stacks) were rejected after shrink and in-map inspection. Their task IDs,
screens and metadata remain. The third, single-sack source permits controlled
stacking. An outlined starburst scar and an overly contrasty aggregate pass
were replaced by irregular quieter spall. First normal correction exposed
disconnected source vertices; welding coincident vertices before smoothing
fixed the prop while retaining UV seams and1043triangles. No architecture
normals were recalculated. Placement tests caught one chip patch beyond its
wall edge and one powder apron overlapping adjacent cover; both were corrected.
Initial typecheck caught private inspection access/DOM test configuration;
an inspection method and the existing client-test split resolve these. No
threshold or assertion was weakened. Early stress/captures are retained as
preflight; all final acceptance was refreshed after the last visual correction.

Meshy: **90credits**, two rejects and one adopted asset; fresh account1230,
programme1000 of1300 remain. This follows the owner's later150/session cap.
Raw8,104,804 ->512px86,988 -> final83,456bytes, one mesh/material/image,
1043triangles and54,770bytes of source geometry accessors. Repeated geometry
adds100128triangles; damage adds48. Metadata contains all task IDs and hashes.
The explicitly allowlisted asset is original/generated; purchased derivatives
remain ignored. Reproduce with shrink-glb.py, pack-field-sandbag.py and the
commands in public/assets/README.md.

**Measurements.** RTX5070 / Edge152 / ANGLE D3D11,1920x1080,balanced/DPR1.
Each stress fixture runs15s with11 operators,12 weapon streams and explosions,
then drains. No build/test/Blender/second browser overlaps final measurements.
Relay baselines were captured this session; the unchanged other-map baselines
are Session88's verified stress fixtures. “mixed-effects-stress” is all ARs;
“muzzle-effects-stress” uses mixed weapons. Desktop intervals do not establish
GPU execution time, laptop iGPU performance, thermal stability or optimization.

| Fixture | Calls before -> after | Triangles before -> after | Texture MiB before -> after | Max frame ms before -> after |
|---|---:|---:|---:|---:|
|mixed-effects-stress|238 -> 238|196403 -> 296579|46.4115 -> 51.0781|13.9 -> 7.3|
|muzzle-effects-stress|236 -> 236|183877 -> 284053|46.4115 -> 51.0781|7.3 -> 14.0|
|undertow-effects-stress|208 -> 208|205585 -> 205585|45.9674 -> 45.9674|14.0 -> 7.2|
|switchyard-effects-stress|207 -> 207|213257 -> 213257|46.6615 -> 46.6615|7.7 -> 7.3|

All medians6.9ms, p95/p99 about7.1ms. Programs36/36/33/34 and
textures32/32/28/31 remain unchanged. All16 light objects retain type/colour/
intensity; cached shadow policy and one PMREM per scene remain. The atlas grows
from0.6667 to5.3333MiB, an added4.6667MiB; geometry/driver overhead is separate.

Local construction+preparation: mixed-effects-stress 1.0103 -> 1.5430s; muzzle-effects-stress 0.6491 -> 0.7312s; undertow-effects-stress 0.9417 -> 0.9419s; switchyard-effects-stress 1.0261 -> 1.1424s.
Single-run observations include browser/driver cache history and loader work;
they are not CDN timings or isolated shader cost. Fresh gameplay readiness is
reported with the hitch results below.

| Bytes | Before | After | Delta |
|---|---:|---:|---:|
|assets|28083117|28172435|+89318|
|public|35058626|35180024|+121398|
|client|2179454|2189841|+10387|
|map|4795372|4817065|+21693|

Public33.5503MiB remains below60; largest
7,183,364bytes stays below25MiB. Source/public/bundle are frozen at acceptance.
Client SHA256: `55a83a926e5d5551a98e3d0e7ba7755756d0e599d39d8ce3911d4d7f712839d3`.
Sack SHA256: `927db93d34e31719cc658f6c9ab308481eb4536c6f74adc9ad8499078f71766e`.
Reproduce comparisons with `node .inspect/session89-summarize.mjs`.

pnpm typecheck PASS; pnpm test PASS(653passed,6existing skips;90passed files,
4skipped); pnpm build:client PASS; pnpm audit:assets PASS; pnpm build Worker
dry run PASS. Logs: session89-final-{typecheck,test,build-client,audit-assets,
build-worker}.log. Exact required inspector command PASS with zero errors:
`node scripts/inspect-map.mjs --url http://localhost:8796 --shots relay,practice-two`.
Required stills/report copied to session89-required-*. Final eight-view inspector,
three close views, required inspector and normal TDM have zero console errors
or forbidden requests. Three new regression cases cover intact-wall/open-ground
placement, transformed-source exterior packing and malformed/light rejection.

Fresh `tools/reference-audit.ts` output deep-equals Session88. Full/waist cover
65/46,66/62,64/48; A-B/A-C/B-C sprint rotations14.44/11.78/14.44,
14.22/11.33/14.22,14.44/11.56/14.44s. ADS250/200/225/400/165ms;
sprint recovery120/100/130/150/90ms. TDM50/300s, respawn3s, DOM4/8s,
0.5point/flag/s; hostile foley1.4, hit900/1400Hz at.28, five-row feed and
...
`node scripts/hitch-probe.mjs http://localhost:8796 150000 .inspect/hitch.json --assert`.
FFA uses --mode=ffa --assert --assert-first-use. Sequential fresh profiles,
two natural deaths each. Unchanged Session74 policy:1500ms presentation,
150ms main-thread,25ms p99 and5% stalled time; first damage/death150ms.
Session80's five-pair first-use proof stands. No threshold/exclusion changed.

| Mode | Seconds / frames | Max frame / callback ms | p99 upper ms | >150ms / stalled share | First damage / death ms | Gate |
|---|---:|---:|---:|---:|---:|---|
|TDM|90.545 /12961|475.1 /10.8|10|1 /0.525%|10.1 /9.2|PASS|
|FFA|38.071 /5407|538.2 /8.4|10|1 /1.414%|8.0 /8.4|PASS|

Zero shader recompiles and console errors. All reported >150ms startup and
measured intervals remain in the raw reports and are listed here:

- TDM: before-ready gaps184.5ms ending at page1377.8ms,282.7ms at1674.6ms,
  and161.0ms at2993.1ms; after-ready1099.0ms at6293.2ms. Ready at3.4293s,
  first-ready maximum93.5ms. Measured475.1ms at profile t476ms, with36programs,
  32textures and158geometries.
- FFA: before-ready275.5ms ending at page1760.4ms; after-ready621.1ms at
  5716.1ms. Ready at3.4146s, first-ready maximum94.7ms. Measured538.2ms at
  profile t19274ms, with34programs,31textures and151geometries.

The initial TDM profiler interval may overlap startup presentation; the FFA
interval occurs later and is retained as a gameplay presentation stall.
Timing/resource counts alone do not establish its driver/compositor cause.
Passing the accepted policy does not establish a universal150ms ceiling.
Reproduce with `node .inspect/session89-hitch-summary.mjs`; no spike was removed.

Open owner questions/defaults: retain the single-sack fieldworks and shallow
damage(yes); prioritize the new structure-layer/enterable Relay building proof
next(yes); include deferred battle dressing in the map redesign(yes); continue
atlas packing before more independent textures(yes).
No answer blocks progress. Human art/colour-vision/comfort, laptop iGPU/thermal,
real6v6/RTT and Firefox/Safari remain unaccepted. Cleanup and final scope audit
follow; no render/public/bundle change is planned after acceptance.

**Late owner directive and cleanup.** Final audit detected external commit
`c9e1105cea4c29039ea3f2e96b6557a830c901bb` at22:00:58KST, with parent
`c9278ba706f80eebb865817446bf96a101c8bc63`. Its sole change is49 lines in
ART-CONCEPT.md: "places, not arenas" and the A-E map-remaking sequence.
Read the complete addition and moved the structure-authoring/enterable Relay
proof to gap1. Today's cosmetic stage does not satisfy that new structural
brief. Its remaining two planned stages yield to the owner's new priority.
The gallery includes the matched elevated20m vista; future structure sessions
must also record the full91m overhead fixture before and after layout changes.
No tested source, asset or bundle was changed by the external commit; hashes
remain frozen. No commit/push/deploy was performed by this agent.

Preview root50796 matched its recorded21:39:56.1725241+09:00 start time.
The cleanup captured12 owned processes and identity-checked10 stops; the
remaining two exited with parents. session89-cleanup.json confirms no owned
preview process, port8796 listener or inspection browser. All three Meshy jobs
and Blender tasks finished. session89-final-audit.json verifies frozen hashes,
all reports/gallery files,64 clips,63 reference rows, one Session89 entry,
apps/ironsight/** working-tree scope and the explicit documentation-only HEAD
transition. All required gates are green; Places arc A is next.


### Session 90 - 2026-09-10: Places arc A 1/1 - Relay communications room and roof

Read standing brief, Session90 supervisor status and AAA plan in order, then
ART-CONCEPT.md and all63 reference principles. Clean entry on ironsight-aaa,
HEAD38d2694. Owner's "places, not arenas" priority selected. Places A1/1 is
complete and playable by default: structure authoring plus one enterable
Relay building. This does not complete the final three-map layout brief.
Scope apps/ironsight/** only; no commit/push/deploy.

Reference: **R-M02/03/04/07/11/14/18/20, R-L12/14**. Targets: real ground
doorways and firing windows,1.1m sill/roof cover, a reachable+3m roof with
solid ceiling, no capsule penetration at its stair lip,10-15s objective
rotation,20-30s measured contact, unchanged240draw/500k/32texture/64MiB gates.
Implemented traversal, shots, rotation and render checks pass. Contact is
still below target. The two opposed doors are not co-visible in one normal
field of view; a second balanced building and defensive entry/window review
belong to Places B. Human art/readability/fairness remain unaccepted.

**What shipped.** src/map/structures.ts compiles footprint-relative wall
segments and door/window unions, pierced elevated slabs, solid interior cover
and ground-to-tier ramps into the existing Box/RampDef lists. Runtime rendering,
movement, current/historical shots and ground navigation share those exact
objects. The tile yard remains. Invalid apertures/extents and elevated-origin
stairs fail authoring; there is no runtime CSG, parallel collision mesh or new
dependency. docs/STRUCTURES.md documents the contract and its limits.

RELAY_COMMS replaces the sealed x34..56,z34..40 shelter with a22x6m room:
two2m-wide/2.35m-high doors, four windows with1.1m sills, two solid control
consoles,2.72m clear ceiling, a2m-wide internal ramp, +3m roof,1.1m parapets
and4m south drop.35 structural boxes replace one original volume. The old
closed-house dressing and six blast patches leave this footprint; the other
three shelters and96 exterior sacks retain theirs. Ground minimap/blueprint
omit overhead slabs and lintels, and the HUD names COMMS. Existing service
atlas space supplies labels, consoles and surface-aligned tread stripes.
Everything shares existing material batches, images and loading preparation.

The first stair test exposed slope glue undoing box-top support while a
capsule still straddles the roof lip. Preserving the selected supporting top
fixes ascent/descent without a deeper landing. The hit helper also still used
fixed0.4/0.8/1.2m steps after decks grew to3m; it now scales that existing
three-box approximation to each ramp's topY, including the new stair. This
changes higher-ramp shot occlusion across the maps; it remains a coarse slope
approximation. Storage version13 marks the new layout so older snapshots
start fresh through the existing null migration; restore/reset lifecycle
logic is unchanged. No persisted-room bug re-investigation was performed.

**Wow check:** [review gallery](.inspect/session90-review.html) has four
matched before/after pairs: full91m overhead, fixed vista, exterior and roof.
The interior operator still checks the dark room against bright openings.
Player sentence: **"I can fight through the comms room, take the roof, then
drop back into the yard."** Intended reaction, not player testimony.
The normal-input training drill is20.005s,
291 replicated-state samples after a6.226s
ordinary approach. It records ground entry, stair y1.34, roof y3/camera4.65,
fire, south drop to0 and opposite-door entry. No position/HP/bot/clock edits.
The separate normal TDM sequence is20.820s,
196 samples and257 received events, with five stills.
Its central route is not evidence of fighting inside the new room; the fixed
pairs and actual training traversal are the direct proof of this moment.

**Bot and layout evidence.** GroundNavigator passes through both doorways
and under the ceiling, but intentionally avoids stair footprints. Three
natural production-bot TDM rounds record **zero Comms interior visits**;
existing objectives/orders bypass it. Roof navigation is deferred and the
proof does not establish useful combat traffic. Places B must route fights
through its buildings, pair power positions and add the missing sunken tier.
The owner note's "negative boxes need no engine change" is insufficient in
the actual implementation: physics still clamps feet to y>=0, and RampDef
starts at global0. No playable negative route is claimed here.

| Seed / build | Score | Duration s | Initial first-damage median s | Respawn median s | Respawn contacts <5s |
|---|---|---:|---:|---:|---:|
|166588 / before|47:50|241.7|17.1 (12/12)|13.7 (85/95)|4|
|166588 / after|50:49|244.2|17.1 (12/12)|14.0 (91/97)|5|
|166589 / after|50:45|236.9|17.0 (11/12)|13.6 (87/93)|1|
|166590 / after|49:50|231.8|16.9 (12/12)|14.4 (87/96)|2|

Only seed166588 has a same-session before/after baseline; the other two are
additional observations.100ms samples, unobserved contact remains censored.
The combined layout/ramp fix is not an isolated causal experiment. Heatmaps,
life samples and structure occupancy are in session90-after-166588/9/90
bot reports; session90-contact-summary.json collects the numbers. No human
fairness, many-round side win-rate or deployed capacity claim.

Fresh reference audit: Relay74full/57waist, plus14 elevated lintel/slab pieces
(raw height classifier calls these decoration, but they are real support).
Undertow66/62 and Switchyard64/48 retained. Relay A-B/A-C/B-C sprint rotations
14.44/11.78/14.44s; Undertow14.22/11.33/14.22; Switchyard14.44/11.56/14.44.
ADS250/200/225/400/165ms; sprint recovery120/100/130/150/90ms. TDM50/300s,
respawn3s, DOM4/8s and0.5point/flag/s, hostile foley1.4, hit900/1400Hz at.28,
five-row feed and two damage cues retained. Spawn travel is not contact timing.

**Assets and rejected intermediates.** Meshy0credits, no job or generated
asset; supervisor balance1230 (not freshly queried), programme1000of1300
remain. Collision-backed architecture uses the original procedural/Blender
kit. Fresh ground AO2048x1365 is786913bytes (+13272); architecture3475616
bytes (+89836), one1024-square AO image,2290parts/27460source triangles and
8material primitives. Concrete weathering1572->31528triangles; existing
oriented-surface/normal/UV audit passes. Five ramp meshes share one material,
reducing the prior four ramp draws to one. Existing allowlists and per-map
loads apply; purchased derivatives remain ignored. Provenance and exact bake
commands are in public/assets/README.md.

The deeper-landing workaround was rejected when the actual slope-glue error
was isolated. The first fresh bake's vertex-weathering step rejected the old
.92 roughness heuristic because the field palette is.96; explicit relay-0
material selection restores the bake with its one-primitive assertion intact.
A tangent-face test uses1micrometre radius tolerance for floating-point
roundoff; real slab penetration remains asserted at three movement increments.
Old whole-grid/symmetry and scar-count tests now explicitly separate the new
structure from the unchanged mirrored yard. Eleven new cases cover authoring,
traversal, ceiling/roof, authoritative analytic/hybrid hits and packed cladding.
The first final typecheck caught a test-only3D point passed to2D navigation;
the fixture was corrected. No hitch/render budget or production timer changed.

**Measurements.** RTX5070 / Edge152 / ANGLE D3D11,1920x1080,balanced/DPR1.
Four15s fixtures use11 operators,12 weapon streams and explosions, then drain.
Relay baselines were captured this session; unchanged other-map render
baselines are Session89. No build/test/Blender/second browser overlapped final
stress or hitch acceptance. Desktop frame intervals are not GPU execution
times, laptop iGPU performance, thermal acceptance or proof of optimization.

| Fixture | Calls before -> after | Triangles before -> after | Texture MiB before -> after | Max frame ms before -> after |
|---|---:|---:|---:|---:|
|mixed-effects-stress|238 -> 235|296579 -> 297639|51.0781 -> 51.0781|7.2 -> 7.2|
|muzzle-effects-stress|236 -> 233|284053 -> 285113|51.0781 -> 51.0781|13.8 -> 13.9|
|undertow-effects-stress|208 -> 208|205585 -> 205585|45.9674 -> 45.9674|7.2 -> 7.2|
|switchyard-effects-stress|207 -> 207|213257 -> 213257|46.6615 -> 46.6615|7.3 -> 7.2|

All medians6.9ms; final p95/p99 approximately7.1ms. Programs36/36/33/34,
textures32/32/28/31 and all16 light objects remain unchanged. Cached shadows,
one PMREM per scene and no additional pass remain. New resident texture MiB0;
geometry/driver overhead is separate. Local construction+preparation seconds:
mixed-effects-stress 1.5048 -> 1.0130; muzzle-effects-stress 0.6993 -> 0.7298; undertow-effects-stress 0.9419 -> 1.6202; switchyard-effects-stress 1.1424 -> 1.4706.
These single-run values include loader/browser/driver cache history, not CDN
latency or isolated shader cost. Cold gameplay readiness follows below.

| Bytes | Before | After | Delta |
|---|---:|---:|---:|
|assets|28172435|28266408|+93973|
|public|35180024|35310123|+130099|
|client|2189841|2200623|+10782|
|map|4817065|4842409|+25344|

Public33.6744MiB stays below60; largest
7183364bytes remains below25MiB. Vista compression and provenance text account
for the net asset delta beyond the two bakes. Frozen client SHA256:
`22380e89d7134d1732816ed5e5b5296acdf5da0e8803f42bdb3b563e5ee4105f`.
Architecture SHA256: `463e6927d6c3ce4cd93e2fe9b9a8d9809e287327faf9ad185d30281c1f925bfb`.
Reproduce the comparisons with node .inspect/session90-summarize.mjs.

**Gates.** pnpm typecheck PASS; pnpm test PASS (664passed,6existing skips;
91passed files,4skipped); pnpm build:client PASS; pnpm audit:assets PASS;
pnpm build Worker dry run PASS. Logs: session90-final-{typecheck,test,
build-client,build-worker,audit-assets}.log. Exact required inspector command
PASS, zero console errors: node scripts/inspect-map.mjs --url
http://localhost:8796 --shots relay,practice-two. Copies are session90-required-*.
All final fixed views, four stress fixtures, actual traversal and normal TDM
reports contain zero errors and forbidden requests. Inspector browsers closed.

Exact required hitch command: node scripts/hitch-probe.mjs
http://localhost:8796 150000 .inspect/hitch.json --assert.
FFA adds --mode=ffa --assert-first-use. Sequential fresh profiles, two natural
deaths each. Unchanged accepted Session74 policy:1500ms presentation,150ms
main-thread,25ms p99 and5% stalled time; first damage/death150ms. Session80's
five-pair first-use proof stands. No threshold or exclusion was altered.

| Mode | Seconds / frames | Max frame / callback ms | p99 upper ms | >150ms / stalled share | First damage / death ms | Gate |
|---|---:|---:|---:|---:|---:|---|
|TDM|89.555 / 12891|30.3 / 7.3|8|0 / 0.000%|9.4 / 9.4|PASS|
|FFA|60.340 / 8533|1000.3 / 22.2|8|1 / 1.658%|7.7 / 8.6|PASS|

Zero shader recompiles and console errors in both. Every reported >150ms
loading or measurement interval remains in the raw reports:

- TDM: before-ready gaps 177.5ms ending at page1335.6ms; 284.8ms ending at page1908.2ms; 167.8ms ending at page2943.9ms. After-ready startup gaps none. Ready at3.3803s. Measured gaps none.
- FFA: before-ready gaps 277.8ms ending at page2244.8ms; 150.8ms ending at page2520.2ms; 150.7ms ending at page3247.9ms. After-ready startup gaps 1652.7ms ending at page7006.9ms. Ready at3.6944s. Measured gaps 1000.3ms at profile t1000ms, 34programs/31textures/151geometries.

The initial FFA measured interval can overlap startup presentation; these are
not automatically independent pauses. Timing alone does not establish a
driver/compositor/compile cause. The1652.7ms after-ready loading gap is not
hidden by the passing measured policy, and a universal150ms ceiling is not
claimed. Reproduce with node .inspect/session90-hitch-summary.mjs.

Open owner questions/defaults: retain the room/roof proof (yes); make the next
Relay layout send combat through at least two balanced interiors (yes); keep
bots on ground until vertical routing is proven (yes); resolve actual floor/
codec constraints before shipping a trench (yes). No answer blocks progress.
Human visual/colour-vision/comfort, laptop iGPU/thermal, real6v6/RTT and
Firefox/Safari remain unaccepted.

Cleanup: preview root59336 matched its recorded start time
2026-09-10T22:19:34.9267678+09:00. Captured12 owned processes; stopped
10 after identity checks, remaining children exited with parents.
session90-cleanup.json confirms zero owned preview processes, port8796
listeners or inspection browsers. No Meshy job; both Blender bakes completed.
Final scope/hash/reference/gallery audit is recorded in session90-final-audit.json.
No commit/push/deploy. Places B is the next ranked arc.


### Session 91 - 2026-09-10: Places B 1/3 - paired Relay rooms and roof counterplay

Read the standing brief, Session91 status and AAA plan in order, then the art
concept and all63 reference principles. Clean entry on ironsight-aaa, HEAD
2bd5799830c1f4e674bc0404f38344bcd6c6ec1d. Scope apps/ironsight/** only;
no commit/push/deploy. Places B1/3 is playable and ON by default. B2/3 is the
sunken route; B3/3 completes the surrounding Relay site. The whole redesign
is not complete, and no negative floor or roof bot routing is claimed today.

Reference: **R-M01/02/03/04/07/08/11/14/18/20, R-G20, R-L11/12/14**.
Targets: two real enterable buildings; matched +3m roof positions; both main
door apertures visible within a conservative78-degree horizontal span;1.1m sill/parapet cover;
10-15s rotations;20-30s observed contact; unchanged240draw/500ktriangle/
32texture/64MiB render ceilings. Buildings, traversal, door view, shots,
rotation and render gates pass. Contact and whole-map/human balance remain
partial. Windows can be vaulted: two primary doors is not two attack directions.

**Delivered.** COMMS/WEST expands from22x6 to22x10m atx34..56,z34..44.
CONTROL/EAST replaces the opposite sealed shelter atx94..116 with exact
x-mirrored walls, stair opening, consoles and roof. Each has two2m-wide,
2.35m-high yard-facing doors, seven permanent1.1m-sill windows, three solid
consoles,2.72m ceiling, internal2m-wide ramp to y3,1.1m parapets and4m south
drop. The central console offers a readable view of both inner door apertures;
oblique jambs still screen portions of the outside pavement. Standing roof
fire crosses between the buildings; crouching behind the parapet blocks it.

Two old yard returns in the enlarged rooms/door aprons are removed. The core,
rifle corridor and southern freight lane remain. The northern rusher route
crosses both rooms; paired quiet-time patrol anchors include their interiors
instead of touring spawn bays. Bot decisions still use fixed map knowledge,
ordinary sight/hearing/reaction, and server-verified fire. No HP, damage,
aim, movement speed or timeout buff. GroundNavigator still excludes stairs.
Storage version14 prevents old saved positions from restoring inside the new
layout through the existing null migration. No lifecycle re-investigation.

The existing service atlas carries WEST/EAST signs, console panels and slope
paint; reversed stair stripes follow the actual east slope. The second old
shelter's sealed hardware and six scars disappear with it. Twelve scars on
the two southern shelters and96 exterior sacks remain. No new material draw,
image, light, pass or per-frame bake. docs/STRUCTURES.md documents the pair.

**Wow check:** [review gallery](.inspect/session91-review.html) includes four
matched before/after camera pairs: full91m overhead, vista, west exterior and
east building/roof. Both defensive interiors and the opposite-roof operator
are additional fixed fixtures. Player sentence: **"I can cover both doors
from the console, then take the roof to answer the other building."**
Intended reaction, not player testimony.

Ordinary-input training drills: west 20.007s/289samples after 9.413s approach; east 20.006s/281samples after 27.045s approach.
Both enter, climb, reach y3/camera4.65, fire, drop to ground and re-enter through
the second door. No position/HP/bot/clock edits. Separate normal TDM capture
records 20.704s/201samples/233events in the broader bot round; the fixed pairs and actual room traversals
are the direct evidence for the new moment. Inspection reports and all stills
are session91-{before,final,drill-west,drill-east,live,required}*.

**Natural production-bot evidence.** Three final full6v6 TDM rounds,100ms
samples, no observer seat or scripted gameplay. Unobserved damage is censored.
Medians use the arithmetic mean of the two central samples for an even count.
Only seed166588 has a same-session before baseline. Indoor columns count
shooter positions for kills / victim positions for deaths; they do not imply
both combatants were indoors.

|Build / seed|Score|Duration s|Initial first-damage median s (observed/total)|Respawn median s (observed/total)|Respawn contacts<5s|Indoor kills / deaths|
|---|---|---:|---:|---:|---:|---:|
|before / 166588|50:49|244.2|17.35 (12/12)|14.00 (91/97)|5|0 / 0|
|after-166588 / 166588|45:50|226.5|16.35 (12/12)|16.70 (84/95)|1|2 / 2|
|after-166589 / 166589|46:50|225.9|15.75 (12/12)|18.05 (84/94)|2|3 / 5|
|after-166590 / 166590|50:42|204.9|15.70 (12/12)|16.50 (82/90)|0|3 / 2|

The final rooms see64.5/67.0/65.6combined player-seconds and5/4/5distinct
visitors; baseline zero. Both rooms get traffic and combat across the seeds.
Opening contact gets earlier while matched respawn contact gets later; do not
call this overall pacing acceptance. Heatmaps, route/occupancy samples and
lives are session91-after-166588/9/90-bot-*; session91-contact-summary.json
collects them. Heatmaps project overhead slabs as solids and are death-location
plots, not ground walkability maps. No many-round side fairness/human claim.

Fresh reference audit: Relay197colliders,87full/76waist plus34raised lintel/
slab parts (height-only audit labels these decoration, despite real support).
Undertow66/62 and Switchyard64/48 retained. A-B/A-C/B-C sprint rotations:
Relay14.44/11.78/14.44s, Undertow14.22/11.33/14.22, Switchyard14.44/11.56/14.44.
ADS250/200/225/400/165ms; sprint recovery120/100/130/150/90ms; TDM50/300s,
respawn3s, DOM4/8s and0.5point/flag/s; hostile foley1.4, hit900/1400Hz at.28,
five-row feed and two damage cues retained. Spawn travel is not observed contact.

**Assets and rejected intermediates.** Meshy0credits, no jobs or new generated
props. Supervisor balance1230 (not freshly queried); programme1000of1300
remain. This collision-exact architecture uses the original procedural kit.
Ground AO2048x1365:805863bytes (+18950),195permanent boxes/six ramps.
Architecture3638360bytes (+162744),2366parts/28368pre-weathering triangles,
eight primitives and one1024-square AO image. Concrete weathering2148->32884
triangles; oriented surfaces/normals/UV audit passes. Combined bakes+181694
bytes; no new resident textures. Exact reproduction/provenance in assets/README.

The rusher-only route intermediate gave two visitors and zero indoor shooter
kills; the final patrol anchors bring additional roles into the rooms. Retained
as session91-candidate-bot-*. The initial door visibility fixture aimed beyond
the thick jambs and failed at oblique edges; the corrected check measures the
actual inner aperture and records that limit. It does not claim the outside
approach is fully exposed. All shader/gate thresholds and exclusions remain.

**Measurements.** RTX5070, Edge152/ANGLE D3D11,1920x1080,balanced/DPR1.
Four15s stress fixtures with11operators,12weapon streams and explosions,
followed by drain. Relay baselines are this session; unchanged other-map
baselines are Session90. Final browser acceptance ran without overlapping
builds/tests/Blender/second inspection browsers. Frame intervals are not GPU
execution time, laptop iGPU/thermal proof, or an isolated causal optimization.

|Fixture|Calls before -> after|Triangles before -> after|Texture MiB before -> after|Max frame ms before -> after|
|---|---:|---:|---:|---:|
|mixed-effects-stress|235 -> 235|297639 -> 299275|51.0781 -> 51.0781|14.0 -> 7.3|
|muzzle-effects-stress|233 -> 233|285113 -> 286749|51.0781 -> 51.0781|7.3 -> 7.3|
|undertow-effects-stress|208 -> 208|205585 -> 205585|45.9674 -> 45.9674|7.2 -> 14.0|
|switchyard-effects-stress|207 -> 207|213257 -> 213257|46.6615 -> 46.6615|7.2 -> 7.3|

All final medians6.9ms, p95/p99 about7.1ms; programs36/36/33/34 and textures
32/32/28/31 unchanged. All16light objects keep type/colour/intensity; pooled
flash positions differ with sample time. Cached shadows, one PMREM per scene
and the existing pass count remain. Texture delta0MiB; geometry/driver overhead
is separate. Local construction+preparation seconds:
mixed-effects-stress 1.8673 -> 1.0255; muzzle-effects-stress 0.6997 -> 0.7297; undertow-effects-stress 1.6202 -> 0.9917; switchyard-effects-stress 1.4706 -> 0.9902.
Single observations include loader/browser/driver cache history, not CDN timing.
Fresh gameplay readiness and every startup spike follow below.

|Bytes|Before|After|Delta|
|---|---:|---:|---:|
|assetBytes|28266408|28452763|+186355|
|publicBytes|35310123|35504008|+193885|
|maxFileBytes|7183364|7183364|+0|
|public/client.js|2200623|2203098|+2475|
|public/client.js.map|4842409|4847464|+5055|

Public33.8593MiB <60; largest7183364bytes <25MiB.
Vista compression/provenance text explain the net asset delta beyond bakes.
Frozen client SHA256: bb03b255c9c98ff62c566d7cae427b09213c1000d2937527eed5931fa69615ff.
Architecture SHA256: 5587e617b849d9c1f7f3f8963e51bfb1aa572de983d23579f1dcd98c8f17f211.
Reproduce with node .inspect/session91-summarize.mjs.

**Gates.** pnpm typecheck PASS; pnpm test PASS(676passed,6existing skips;
91passed files,4skipped); pnpm build:client PASS; pnpm audit:assets PASS;
pnpm build Worker dry run PASS. Logs: session91-final-{typecheck,test,
build-client,build-worker,audit-assets}.log. Exact required inspector PASS,
zero console errors: node scripts/inspect-map.mjs --url http://localhost:8796
--shots relay,practice-two. Copies are session91-required-*. Final fixed views,
four stress fixtures, both real traversal drills and normal TDM reports have
zero errors/forbidden requests. New/extended tests cover paired traversal,
co-visible doors, exact mirrored collision, all-window/roof rays, actual room
analytic/hybrid hits, both ramp claddings and reachable patrol anchors.

Exact hitch command: node scripts/hitch-probe.mjs http://localhost:8796
150000 .inspect/hitch.json --assert. FFA adds --mode=ffa --assert-first-use.
Sequential fresh profiles with two natural deaths each. Unchanged accepted
Session74 policy:1500ms presentation,150ms main-thread,25ms p99,5% stalled
time; first damage/death150ms. Session80's five-pair first-use proof stands.

|Mode|Seconds / frames|Max frame / callback ms|p99 upper ms|>150ms / stalled share|First damage / death ms|Gate|
|---|---:|---:|---:|---:|---:|---|
|TDM|86.248 / 12409|19.4 / 8.6|8|0 / 0.000%|7.8 / 8.0|PASS|
|FFA|53.067 / 7526|783.0 / 8.6|10|1 / 1.475%|13.2 / 13.2|PASS|

Zero shader recompiles and console errors. All >150ms loading/measurement
intervals remain in raw reports and are listed here:

- TDM: ready at 3.5816s. Before-ready gaps: 175.7ms ending at page 1521.1ms; 275.8ms ending at page 2086.5ms; 176.8ms ending at page 3140.3ms. After-ready startup gaps: none. Measured >150ms intervals: none.
- FFA: ready at 3.4660s. Before-ready gaps: 267.6ms ending at page 2021.4ms; 152.1ms ending at page 2968.0ms. After-ready startup gaps: 1389.9ms ending at page 6532.3ms. Measured >150ms intervals: {"t":783,"dt":783,"alive":true,"near":18,"enemies":11,"programs":34,"textures":31,"geometries":151}.

Initial measured intervals may overlap startup presentation. Timing/resource
counts alone do not establish a driver/compositor/compile cause. Passing this
accepted policy does not establish a universal150ms ceiling. Reproduce with
node .inspect/session91-hitch-summary.mjs; no spike was removed.

Open owner questions/defaults: retain the paired rooms and patrol traffic(yes);
implement a real shared negative-floor contract before the trench(yes); keep
bots ground-only until tier routing is proven(yes); reserve broader boundary/
asymmetry/dressing work for the following site stage(yes). No answer blocks
progress. Human art/colour-vision/comfort, laptop iGPU/thermal, real6v6/RTT
and Firefox/Safari remain unaccepted. Cleanup/final scope audit follow;
no tested source, asset or bundle change is planned after acceptance.

Cleanup: preview root50356 matched its recorded start time
2026-09-10T23:00:02.0579100+09:00. Captured12 owned processes; stopped10
with identity checks, and the remaining children exited with parents.
session91-cleanup.json confirms zero owned preview processes, port8796
listeners or inspection browsers. No Meshy jobs; Blender work completed.
session91-final-audit.json records the final scope, source/public hashes,
gallery links,63reference rows,64unchanged source clips and accepted gates.
No commit/push/deploy. Places B2/3 is the next ranked stage.
