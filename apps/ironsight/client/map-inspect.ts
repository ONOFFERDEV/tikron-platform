...
export function startMapInspector(): void {
  ...
  const shots: Record<string, readonly [number, number, number, number, number, number]> = {
    ...
    'undertow-site-west': [8, 1.65, 39, -7, 4, 45],
    'undertow-site-east': [143, 1.65, 77, 152, 6, 57],
    'undertow-site-south': [104, 4.65, 61.5, 75, 5, 116],
    'undertow-site-quay': [93, 1.65, 99, 110, 1.1, 118],
    ...
    'switchyard-room-front': [54, 1.65, 67, 42, 1.8, 61],
    'switchyard-room-west': [40, 1.65, 62.8, 48, 1.4, 59.7],
