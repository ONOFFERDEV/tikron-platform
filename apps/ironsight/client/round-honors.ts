...
.round-honors{margin-block-end:var(--ui-space-6);padding:var(--ui-space-4);border:var(--ui-border-width) solid var(--ui-border-subtle);border-inline-start:var(--ui-border-emphasis) solid var(--ui-accent);background:var(--ui-surface-2);color:var(--ui-text-primary)}
.round-honors__title{margin:0;color:var(--ui-accent);font-size:var(--ui-type-meta);font-weight:700}.round-honors h3{margin:var(--ui-space-1) 0 var(--ui-space-3);font:700 var(--ui-type-panel)/1.25 var(--ui-font-body);overflow-wrap:anywhere}.round-honors__stats{display:flex;flex-wrap:wrap;gap:var(--ui-space-3) var(--ui-space-6);margin:0}.round-honors__stats div{display:flex;gap:var(--ui-space-2);align-items:baseline}.round-honors__stats dt{color:var(--ui-text-secondary);font-size:var(--ui-type-hud)}.round-honors__stats dd{margin:0;font-weight:700;font-variant-numeric:tabular-nums}
`;
